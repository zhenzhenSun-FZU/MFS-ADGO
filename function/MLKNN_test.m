function [HammingLoss,RankingLoss,Coverage,OneError,Average_Precision,macrof1,microf1,...
    EBA,EBP,EBR,RBF,LBA,LBP,LBR,LBF]...
...
%Evaluation
    ...
    %newly added 8 evaluation matrics
    [EBA,EBP,EBR,RBF]=ExampleBasedMeasure(test_target,Pre_Labels);
    [LBA,LBP,LBR,LBF]=LabelBasedMeasure(test_target,Pre_Labels);
